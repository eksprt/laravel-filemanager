...
[![PHP Composer](https://github.com/eksprt/laravel-filemanager/actions/workflows/php.yml/badge.svg)](https://github.com/eksprt/laravel-filemanager/actions/workflows/php.yml)
[![Latest Version on Packagist](https://img.shields.io/packagist/v/eksprt/laravel-filemanager.svg?style=flat-square)](https://packagist.org/packages/eksprt/laravel-filemanager)
[![Total Downloads](https://img.shields.io/packagist/dt/eksprt/laravel-filemanager.svg?style=flat-square)](https://packagist.org/packages/eksprt/laravel-filemanager)
...
```bash
composer require eksprt/laravel-filemanager
```
...
```bash
php artisan vendor:publish --provider="Eksprt\FileManager\FileManagerServiceProvider" --tag=filemanager-config
```
...
```bash
php artisan vendor:publish --provider="Eksprt\FileManager\FileManagerServiceProvider" --tag=filemanager-migration
```
...
Your Eloquent models should use the `Eksprt\FileManager\Traits\HasFile` trait.
