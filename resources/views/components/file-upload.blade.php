<div class="lm-file-upload-box">
  <div class="{{ $previewClasses }}">
    <img class="img-thumbnail" src="{{ $thumbnail }}" style="max-height:50px;" onclick="changeFile(this)">
  </div>
  ...
  <input name="{{ $name }}" type="file" class="d-none" accept="{{ $accept }}" onchange="chooseFile(this)" data-size="{{ config('filemanager.max_file_size') }}">
