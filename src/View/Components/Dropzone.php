...
class Dropzone extends Component
{
    ...
    public function __construct(
        ...
        $this->max_files = !empty($maxfiles) ? $maxfiles : config('filemanager.max_files');
    ...
    {
        return view('filemanager::components.dropzone');
    }
    ...
    protected function setMaxFilesSize($size)
    {
        ...
        return round(config('filemanager.max_file_size') / 1024 / 1024, 4);
    }
