...
namespace Eksprt\FileManager\Models;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\Storage;
use Eksprt\FileManager\Exceptions\ConversionNotAvailableException;
...
class File extends Model
{
    ...
    public function getFilePath(string $key = 'original'): string
    {
        ...
        if ($conversionNotAvailable && config('filemanager.conversion_missing_exception')) {
